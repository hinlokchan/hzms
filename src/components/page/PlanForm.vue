  ...
  data() {
    return {
	  ...
	  */
      ...
      contactTypeOption: [
        ['正常接洽', '摇珠', '中行通知书', '定点采购', '中介超市', '政府采购', '招标委托', '河源分公司', '深圳分公司', '广州分公司', '汕尾分公司', '汕头分公司', '东莞分公司', '海南分公司'],
        ['正常接洽', '摇珠', '中行通知书', '定点采购', '中介超市', '惠正公司', '汇正公司', '政府采购', '招标委托'],
        ['正常接洽', '摇珠', '中行通知书', '定点采购', '中介超市', '惠正公司', '智明公司', '政府采购', '招标委托']
      ],
	  userList: [],
	  projTypes: [
		  {
