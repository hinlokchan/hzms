<template>
  <div class="container">
	...
	v-if="subInfoForm">
      <span class="work-title-name">子项目信息 <el-tag :type="newButtonType(subInfoForm.mainStatus)" plain size="medium">{{newButtonValue(subInfoForm.mainStatus)}}</el-tag></span>
	...
	<div style="text-align: center;">
		<el-button-group>
			<el-button :type="newButtonType(subInfoForm.mainStatus)" plain size="medium">{{newButtonValue(subInfoForm.mainStatus)}}</el-button>
							...
							this.getSubProjectData(projId, subProjId, (spData)=>{
								this.getWorkAssignmentData(projId, subProjId, (waData)=>{
									...
									if(spData){
										...
										this.subInfoForm.status = spData.subProjStatus.mainStatus; //正评状态
